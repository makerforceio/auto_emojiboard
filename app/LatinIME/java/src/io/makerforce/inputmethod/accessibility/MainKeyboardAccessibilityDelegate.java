...
package io.makerforce.inputmethod.accessibility;
...
import io.makerforce.inputmethod.keyboard.KeyDetector;
...
import io.makerforce.inputmethod.keyboard.PointerTracker;
...
public final class MainKeyboardAccessibilityDelegate
    ...
    static {
        KEYBOARD_MODE_RES_IDS.put(KeyboardId.MODE_DATE, io.makerforce.inputmethod.latin.R.string.keyboard_mode_date);
        KEYBOARD_MODE_RES_IDS.put(KeyboardId.MODE_DATETIME, io.makerforce.inputmethod.latin.R.string.keyboard_mode_date_time);
        KEYBOARD_MODE_RES_IDS.put(KeyboardId.MODE_EMAIL, io.makerforce.inputmethod.latin.R.string.keyboard_mode_email);
        KEYBOARD_MODE_RES_IDS.put(KeyboardId.MODE_IM, io.makerforce.inputmethod.latin.R.string.keyboard_mode_im);
        KEYBOARD_MODE_RES_IDS.put(KeyboardId.MODE_NUMBER, io.makerforce.inputmethod.latin.R.string.keyboard_mode_number);
        KEYBOARD_MODE_RES_IDS.put(KeyboardId.MODE_PHONE, io.makerforce.inputmethod.latin.R.string.keyboard_mode_phone);
        KEYBOARD_MODE_RES_IDS.put(KeyboardId.MODE_TEXT, io.makerforce.inputmethod.latin.R.string.keyboard_mode_text);
        KEYBOARD_MODE_RES_IDS.put(KeyboardId.MODE_TIME, io.makerforce.inputmethod.latin.R.string.keyboard_mode_time);
        KEYBOARD_MODE_RES_IDS.put(KeyboardId.MODE_URL, io.makerforce.inputmethod.latin.R.string.keyboard_mode_url);
    }
    ...
    private void announceKeyboardMode(final Keyboard keyboard) {
        ...
        final String text = context.getString(io.makerforce.inputmethod.latin.R.string.announce_keyboard_mode, modeText);
    ...
    private void announceKeyboardType(final Keyboard keyboard, final Keyboard lastKeyboard) {
        ...
        case KeyboardId.ELEMENT_ALPHABET:
            ...
            resId = io.makerforce.inputmethod.latin.R.string.spoken_description_mode_alpha;
            break;
        case KeyboardId.ELEMENT_ALPHABET_MANUAL_SHIFTED:
            ...
            resId = io.makerforce.inputmethod.latin.R.string.spoken_description_shiftmode_on;
            break;
        case KeyboardId.ELEMENT_ALPHABET_SHIFT_LOCK_SHIFTED:
            ...
            resId = io.makerforce.inputmethod.latin.R.string.spoken_description_shiftmode_locked;
            break;
        case KeyboardId.ELEMENT_ALPHABET_SHIFT_LOCKED:
            resId = io.makerforce.inputmethod.latin.R.string.spoken_description_shiftmode_locked;
            break;
        case KeyboardId.ELEMENT_SYMBOLS:
            resId = io.makerforce.inputmethod.latin.R.string.spoken_description_mode_symbol;
            break;
        case KeyboardId.ELEMENT_SYMBOLS_SHIFTED:
            resId = io.makerforce.inputmethod.latin.R.string.spoken_description_mode_symbol_shift;
            break;
        case KeyboardId.ELEMENT_PHONE:
            resId = io.makerforce.inputmethod.latin.R.string.spoken_description_mode_phone;
            break;
        case KeyboardId.ELEMENT_PHONE_SYMBOLS:
            resId = io.makerforce.inputmethod.latin.R.string.spoken_description_mode_phone_shift;
            break;
        default:
            return;
        }
    ...
    private void announceKeyboardHidden() {
        sendWindowStateChanged(io.makerforce.inputmethod.latin.R.string.announce_keyboard_hidden);
    }
