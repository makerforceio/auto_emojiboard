...
import io.makerforce.inputmethod.latin.BinaryDictionaryFileDumper;
...
public final class DictionaryService extends Service {
     ...
     */
    private static final String PACKAGE_NAME = "io.makerforce.inputmethod.latin";
    ...
    static void dispatchBroadcast(final Context context, final Intent intent) {
        ...
        if (DATE_CHANGED_INTENT_ACTION.equals(action)) {
            ...
            final String mClientId = context.getString(io.makerforce.inputmethod.latin.R.string.dictionary_pack_client_id);
    ...
    private static void showStartDownloadingToast(final Context context,
        ...
        final String toastText = String.format(
                context.getString(io.makerforce.inputmethod.latin.R.string.toast_downloading_suggestions),
