...
public class ButtonSwitcher extends FrameLayout {
    ...
    protected void onLayout(final boolean changed, final int left, final int top, final int right,
        ...
        mInstallButton = (Button)findViewById(io.makerforce.inputmethod.latin.R.id.dict_install_button);
        mCancelButton = (Button)findViewById(io.makerforce.inputmethod.latin.R.id.dict_cancel_button);
        mDeleteButton = (Button)findViewById(io.makerforce.inputmethod.latin.R.id.dict_delete_button);
