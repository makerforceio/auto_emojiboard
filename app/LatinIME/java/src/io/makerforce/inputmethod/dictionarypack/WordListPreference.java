...
public final class WordListPreference extends Preference {
    ...
    public WordListPreference(final Context context,
        ...
        setLayoutResource(io.makerforce.inputmethod.latin.R.layout.dictionary_line);
    ...
    private String getSummary(final int status) {
        ...
        case MetadataDbHelper.STATUS_AVAILABLE:
            return context.getString(io.makerforce.inputmethod.latin.R.string.dictionary_available);
        case MetadataDbHelper.STATUS_DOWNLOADING:
            return context.getString(io.makerforce.inputmethod.latin.R.string.dictionary_downloading);
        case MetadataDbHelper.STATUS_INSTALLED:
            return context.getString(io.makerforce.inputmethod.latin.R.string.dictionary_installed);
        case MetadataDbHelper.STATUS_DISABLED:
            return context.getString(io.makerforce.inputmethod.latin.R.string.dictionary_disabled);
        default:
    ...
    protected void onBindView(final View view) {
        ...
        final DictionaryDownloadProgressBar progressBar =
                (DictionaryDownloadProgressBar)view.findViewById(io.makerforce.inputmethod.latin.R.id.dictionary_line_progress_bar);
        ...
        final ButtonSwitcher buttonSwitcher = (ButtonSwitcher)view.findViewById(
                io.makerforce.inputmethod.latin.R.id.wordlist_button_switcher);
    ...
    void onWordListClicked(final View v) {
        ...
        for (int i = 0; i <= lastDisplayedIndex; ++i) {
            final ButtonSwitcher buttonSwitcher = (ButtonSwitcher)listView.getChildAt(i)
                    .findViewById(io.makerforce.inputmethod.latin.R.id.wordlist_button_switcher);
            if (i == indexToOpen) {
                buttonSwitcher.setStatusAndUpdateVisuals(getButtonSwitcherStatus(mStatus));
            } else {
                buttonSwitcher.setStatusAndUpdateVisuals(ButtonSwitcher.STATUS_NO_BUTTON);
