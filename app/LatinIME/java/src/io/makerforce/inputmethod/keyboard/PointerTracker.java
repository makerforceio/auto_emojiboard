...
import io.makerforce.inputmethod.keyboard.internal.BatchInputArbiter;
import io.makerforce.inputmethod.keyboard.internal.BogusMoveEventDetector;
import io.makerforce.inputmethod.keyboard.internal.DrawingProxy;
import io.makerforce.inputmethod.keyboard.internal.GestureEnabler;
import io.makerforce.inputmethod.keyboard.internal.GestureStrokeDrawingParams;
import io.makerforce.inputmethod.keyboard.internal.GestureStrokeDrawingPoints;
import io.makerforce.inputmethod.keyboard.internal.GestureStrokeRecognitionParams;
import io.makerforce.inputmethod.keyboard.internal.PointerTrackerQueue;
import io.makerforce.inputmethod.keyboard.internal.TimerProxy;
import io.makerforce.inputmethod.keyboard.internal.TypingTimeRecorder;
    ...
    static final class PointerTrackerParams {
        ...
        public PointerTrackerParams(final TypedArray mainKeyboardViewAttr) {
            mKeySelectionByDraggingFinger = mainKeyboardViewAttr.getBoolean(
                    io.makerforce.inputmethod.latin.R.styleable.MainKeyboardView_keySelectionByDraggingFinger, false);
            mTouchNoiseThresholdTime = mainKeyboardViewAttr.getInt(
                    io.makerforce.inputmethod.latin.R.styleable.MainKeyboardView_touchNoiseThresholdTime, 0);
            mTouchNoiseThresholdDistance = mainKeyboardViewAttr.getDimensionPixelSize(
                    io.makerforce.inputmethod.latin.R.styleable.MainKeyboardView_touchNoiseThresholdDistance, 0);
            mSuppressKeyPreviewAfterBatchInputDuration = mainKeyboardViewAttr.getInt(
                    io.makerforce.inputmethod.latin.R.styleable.MainKeyboardView_suppressKeyPreviewAfterBatchInputDuration, 0);
            mKeyRepeatStartTimeout = mainKeyboardViewAttr.getInt(
                    io.makerforce.inputmethod.latin.R.styleable.MainKeyboardView_keyRepeatStartTimeout, 0);
            mKeyRepeatInterval = mainKeyboardViewAttr.getInt(
                    io.makerforce.inputmethod.latin.R.styleable.MainKeyboardView_keyRepeatInterval, 0);
            mLongPressShiftLockTimeout = mainKeyboardViewAttr.getInt(
                    io.makerforce.inputmethod.latin.R.styleable.MainKeyboardView_longPressShiftLockTimeout, 0);
        }
    }
    ...
    public static void init(final TypedArray mainKeyboardViewAttr, final TimerProxy timerProxy,
        ...
        sNeedsPhantomSuddenMoveEventHack = Boolean.parseBoolean(
                ResourceUtils.getDeviceOverrideValue(res,
                        io.makerforce.inputmethod.latin.R.array.phantom_sudden_move_event_device_list, Boolean.FALSE.toString()));
