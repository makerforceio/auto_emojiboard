...
import io.makerforce.inputmethod.compat.InputMethodSubtypeCompatUtils;
import io.makerforce.inputmethod.compat.UserManagerCompatUtils;
import io.makerforce.inputmethod.keyboard.internal.KeyboardBuilder;
import io.makerforce.inputmethod.keyboard.internal.KeyboardParams;
import io.makerforce.inputmethod.keyboard.internal.UniqueKeysCache;
import io.makerforce.inputmethod.latin.InputAttributes;
import io.makerforce.inputmethod.latin.RichInputMethodSubtype;
import io.makerforce.inputmethod.latin.utils.InputTypeUtils;
import io.makerforce.inputmethod.latin.utils.ScriptUtils;
import io.makerforce.inputmethod.latin.utils.SubtypeLocaleUtils;
import io.makerforce.inputmethod.latin.utils.XmlParseUtils;
    ...
    public static final class Builder {
        ...
        private static int readScriptIdFromTagFeature(final Resources resources,
            ...
            final TypedArray featureAttr = resources.obtainAttributes(Xml.asAttributeSet(parser),
                    io.makerforce.inputmethod.latin.R.styleable.KeyboardLayoutSet_Feature);
            try {
                final int scriptId =
                        featureAttr.getInt(io.makerforce.inputmethod.latin.R.styleable.KeyboardLayoutSet_Feature_supportedScript,
        ...
        private static int getXmlId(final Resources resources, final String keyboardLayoutSetName) {
            final String packageName = resources.getResourcePackageName(
                    io.makerforce.inputmethod.latin.R.xml.keyboard_layout_set_qwerty);
        ...
        private void parseKeyboardLayoutSetElement(final XmlPullParser parser)
            ...
            final TypedArray a = mResources.obtainAttributes(Xml.asAttributeSet(parser),
                    io.makerforce.inputmethod.latin.R.styleable.KeyboardLayoutSet_Element);
            try {
                XmlParseUtils.checkAttributeExists(a,
                        io.makerforce.inputmethod.latin.R.styleable.KeyboardLayoutSet_Element_elementName, "elementName",
                        TAG_ELEMENT, parser);
                XmlParseUtils.checkAttributeExists(a,
                        io.makerforce.inputmethod.latin.R.styleable.KeyboardLayoutSet_Element_elementKeyboard, "elementKeyboard",
                        TAG_ELEMENT, parser);
                XmlParseUtils.checkEndTag(TAG_ELEMENT, parser);

                final ElementParams elementParams = new ElementParams();
                final int elementName = a.getInt(
                        io.makerforce.inputmethod.latin.R.styleable.KeyboardLayoutSet_Element_elementName, 0);
                elementParams.mKeyboardXmlId = a.getResourceId(
                        io.makerforce.inputmethod.latin.R.styleable.KeyboardLayoutSet_Element_elementKeyboard, 0);
                elementParams.mProximityCharsCorrectionEnabled = a.getBoolean(
                        io.makerforce.inputmethod.latin.R.styleable.KeyboardLayoutSet_Element_enableProximityCharsCorrection,
                        false);
                elementParams.mSupportsSplitLayout = a.getBoolean(
                        io.makerforce.inputmethod.latin.R.styleable.KeyboardLayoutSet_Element_supportsSplitLayout, false);
                elementParams.mAllowRedundantMoreKeys = a.getBoolean(
                        io.makerforce.inputmethod.latin.R.styleable.KeyboardLayoutSet_Element_allowRedundantMoreKeys, true);
