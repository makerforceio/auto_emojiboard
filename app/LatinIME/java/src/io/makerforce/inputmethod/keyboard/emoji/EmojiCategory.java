...
import io.makerforce.inputmethod.compat.BuildCompatUtils;
import io.makerforce.inputmethod.keyboard.Key;
import io.makerforce.inputmethod.keyboard.Keyboard;
import io.makerforce.inputmethod.keyboard.KeyboardId;
import io.makerforce.inputmethod.keyboard.KeyboardLayoutSet;
import io.makerforce.inputmethod.latin.settings.Settings;
...
final class EmojiCategory {
    ...
    private static final int[] sCategoryTabIconAttr = {
            io.makerforce.inputmethod.latin.R.styleable.EmojiPalettesView_iconEmojiRecentsTab,
            io.makerforce.inputmethod.latin.R.styleable.EmojiPalettesView_iconEmojiCategory1Tab,
            io.makerforce.inputmethod.latin.R.styleable.EmojiPalettesView_iconEmojiCategory2Tab,
            io.makerforce.inputmethod.latin.R.styleable.EmojiPalettesView_iconEmojiCategory3Tab,
            io.makerforce.inputmethod.latin.R.styleable.EmojiPalettesView_iconEmojiCategory4Tab,
            io.makerforce.inputmethod.latin.R.styleable.EmojiPalettesView_iconEmojiCategory5Tab,
            io.makerforce.inputmethod.latin.R.styleable.EmojiPalettesView_iconEmojiCategory6Tab,
            io.makerforce.inputmethod.latin.R.styleable.EmojiPalettesView_iconEmojiCategory7Tab,
            io.makerforce.inputmethod.latin.R.styleable.EmojiPalettesView_iconEmojiCategory8Tab,
            io.makerforce.inputmethod.latin.R.styleable.EmojiPalettesView_iconEmojiCategory9Tab,
            io.makerforce.inputmethod.latin.R.styleable.EmojiPalettesView_iconEmojiCategory10Tab,
            io.makerforce.inputmethod.latin.R.styleable.EmojiPalettesView_iconEmojiCategory11Tab,
            io.makerforce.inputmethod.latin.R.styleable.EmojiPalettesView_iconEmojiCategory12Tab,
            io.makerforce.inputmethod.latin.R.styleable.EmojiPalettesView_iconEmojiCategory13Tab,
            io.makerforce.inputmethod.latin.R.styleable.EmojiPalettesView_iconEmojiCategory14Tab,
            io.makerforce.inputmethod.latin.R.styleable.EmojiPalettesView_iconEmojiCategory15Tab,
            io.makerforce.inputmethod.latin.R.styleable.EmojiPalettesView_iconEmojiCategory16Tab };

    private static final int[] sAccessibilityDescriptionResourceIdsForCategories = {
            io.makerforce.inputmethod.latin.R.string.spoken_descrption_emoji_category_recents,
            io.makerforce.inputmethod.latin.R.string.spoken_descrption_emoji_category_people,
            io.makerforce.inputmethod.latin.R.string.spoken_descrption_emoji_category_objects,
            io.makerforce.inputmethod.latin.R.string.spoken_descrption_emoji_category_nature,
            io.makerforce.inputmethod.latin.R.string.spoken_descrption_emoji_category_places,
            io.makerforce.inputmethod.latin.R.string.spoken_descrption_emoji_category_symbols,
            io.makerforce.inputmethod.latin.R.string.spoken_descrption_emoji_category_emoticons,
            io.makerforce.inputmethod.latin.R.string.spoken_descrption_emoji_category_flags,
            io.makerforce.inputmethod.latin.R.string.spoken_descrption_emoji_category_eight_smiley_people,
            io.makerforce.inputmethod.latin.R.string.spoken_descrption_emoji_category_eight_animals_nature,
            io.makerforce.inputmethod.latin.R.string.spoken_descrption_emoji_category_eight_food_drink,
            io.makerforce.inputmethod.latin.R.string.spoken_descrption_emoji_category_eight_travel_places,
            io.makerforce.inputmethod.latin.R.string.spoken_descrption_emoji_category_eight_activity,
            io.makerforce.inputmethod.latin.R.string.spoken_descrption_emoji_category_objects,
            io.makerforce.inputmethod.latin.R.string.spoken_descrption_emoji_category_symbols,
            io.makerforce.inputmethod.latin.R.string.spoken_descrption_emoji_category_flags,
            io.makerforce.inputmethod.latin.R.string.spoken_descrption_emoji_category_eight_smiley_people };
    ...
    public EmojiCategory(final SharedPreferences prefs, final Resources res,
        ...
        mPrefs = prefs;
        mRes = res;
        mMaxPageKeyCount = res.getInteger(io.makerforce.inputmethod.latin.R.integer.config_emoji_keyboard_max_page_key_count);
