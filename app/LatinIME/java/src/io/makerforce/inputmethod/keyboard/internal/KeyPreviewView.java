...
public class KeyPreviewView extends TextView {
    ...
    private static final int[][][] KEY_PREVIEW_BACKGROUND_STATE_TABLE = {
        { // POSITION_MIDDLE
            {},
            { io.makerforce.inputmethod.latin.R.attr.state_has_morekeys }
        },
        { // POSITION_LEFT
            { io.makerforce.inputmethod.latin.R.attr.state_left_edge },
            { io.makerforce.inputmethod.latin.R.attr.state_left_edge, io.makerforce.inputmethod.latin.R.attr.state_has_morekeys }
        },
        { // POSITION_RIGHT
            { io.makerforce.inputmethod.latin.R.attr.state_right_edge },
            { io.makerforce.inputmethod.latin.R.attr.state_right_edge, io.makerforce.inputmethod.latin.R.attr.state_has_morekeys }
        }
    };
