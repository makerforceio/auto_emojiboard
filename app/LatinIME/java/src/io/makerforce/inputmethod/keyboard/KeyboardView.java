...
public class KeyboardView extends View {
    ...
    public KeyboardView(final Context context, final AttributeSet attrs) {
        this(context, attrs, io.makerforce.inputmethod.latin.R.attr.keyboardViewStyle);
    }
    ...
    public KeyboardView(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        final TypedArray keyboardViewAttr = context.obtainStyledAttributes(attrs,
                io.makerforce.inputmethod.latin.R.styleable.KeyboardView, defStyle, io.makerforce.inputmethod.latin.R.style.KeyboardView);
        mKeyBackground = keyboardViewAttr.getDrawable(io.makerforce.inputmethod.latin.R.styleable.KeyboardView_keyBackground);
        mKeyBackground.getPadding(mKeyBackgroundPadding);
        final Drawable functionalKeyBackground = keyboardViewAttr.getDrawable(
                io.makerforce.inputmethod.latin.R.styleable.KeyboardView_functionalKeyBackground);
        mFunctionalKeyBackground = (functionalKeyBackground != null) ? functionalKeyBackground
                : mKeyBackground;
        final Drawable spacebarBackground = keyboardViewAttr.getDrawable(
                io.makerforce.inputmethod.latin.R.styleable.KeyboardView_spacebarBackground);
        mSpacebarBackground = (spacebarBackground != null) ? spacebarBackground : mKeyBackground;
        mSpacebarIconWidthRatio = keyboardViewAttr.getFloat(
                io.makerforce.inputmethod.latin.R.styleable.KeyboardView_spacebarIconWidthRatio, 1.0f);
        mKeyHintLetterPadding = keyboardViewAttr.getDimension(
                io.makerforce.inputmethod.latin.R.styleable.KeyboardView_keyHintLetterPadding, 0.0f);
        mKeyPopupHintLetter = keyboardViewAttr.getString(
                io.makerforce.inputmethod.latin.R.styleable.KeyboardView_keyPopupHintLetter);
        mKeyPopupHintLetterPadding = keyboardViewAttr.getDimension(
                io.makerforce.inputmethod.latin.R.styleable.KeyboardView_keyPopupHintLetterPadding, 0.0f);
        mKeyShiftedLetterHintPadding = keyboardViewAttr.getDimension(
                io.makerforce.inputmethod.latin.R.styleable.KeyboardView_keyShiftedLetterHintPadding, 0.0f);
        mKeyTextShadowRadius = keyboardViewAttr.getFloat(
                io.makerforce.inputmethod.latin.R.styleable.KeyboardView_keyTextShadowRadius, KET_TEXT_SHADOW_RADIUS_DISABLED);
        mVerticalCorrection = keyboardViewAttr.getDimension(
                io.makerforce.inputmethod.latin.R.styleable.KeyboardView_verticalCorrection, 0.0f);
        keyboardViewAttr.recycle();

        final TypedArray keyAttr = context.obtainStyledAttributes(attrs,
                io.makerforce.inputmethod.latin.R.styleable.Keyboard_Key, defStyle, io.makerforce.inputmethod.latin.R.style.KeyboardView);
        mDefaultKeyLabelFlags = keyAttr.getInt(io.makerforce.inputmethod.latin.R.styleable.Keyboard_Key_keyLabelFlags, 0);
