...
public final class SlidingKeyInputDrawingPreview extends AbstractDrawingPreview {
    ...
    public SlidingKeyInputDrawingPreview(final TypedArray mainKeyboardViewAttr) {
        final int previewColor = mainKeyboardViewAttr.getColor(
                io.makerforce.inputmethod.latin.R.styleable.MainKeyboardView_slidingKeyInputPreviewColor, 0);
        final float previewRadius = mainKeyboardViewAttr.getDimension(
                io.makerforce.inputmethod.latin.R.styleable.MainKeyboardView_slidingKeyInputPreviewWidth, 0) / 2.0f;
        final int PERCENTAGE_INT = 100;
        final float previewBodyRatio = (float)mainKeyboardViewAttr.getInt(
                io.makerforce.inputmethod.latin.R.styleable.MainKeyboardView_slidingKeyInputPreviewBodyRatio, PERCENTAGE_INT)
        ...
        final int previewShadowRatioInt = mainKeyboardViewAttr.getInt(
                io.makerforce.inputmethod.latin.R.styleable.MainKeyboardView_slidingKeyInputPreviewShadowRatio, 0);
