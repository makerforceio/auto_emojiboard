...
package io.makerforce.inputmethod.keyboard;
...
import io.makerforce.inputmethod.accessibility.AccessibilityUtils;
import io.makerforce.inputmethod.accessibility.MainKeyboardAccessibilityDelegate;
import io.makerforce.inputmethod.annotations.ExternallyReferenced;
import io.makerforce.inputmethod.keyboard.internal.DrawingPreviewPlacerView;
import io.makerforce.inputmethod.keyboard.internal.DrawingProxy;
import io.makerforce.inputmethod.keyboard.internal.GestureFloatingTextDrawingPreview;
import io.makerforce.inputmethod.keyboard.internal.GestureTrailsDrawingPreview;
import io.makerforce.inputmethod.keyboard.internal.KeyDrawParams;
import io.makerforce.inputmethod.keyboard.internal.KeyPreviewChoreographer;
import io.makerforce.inputmethod.keyboard.internal.KeyPreviewDrawParams;
import io.makerforce.inputmethod.keyboard.internal.KeyPreviewView;
import io.makerforce.inputmethod.keyboard.internal.MoreKeySpec;
import io.makerforce.inputmethod.keyboard.internal.NonDistinctMultitouchHelper;
import io.makerforce.inputmethod.keyboard.internal.SlidingKeyInputDrawingPreview;
import io.makerforce.inputmethod.keyboard.internal.TimerHandler;
import io.makerforce.inputmethod.latin.RichInputMethodSubtype;
import io.makerforce.inputmethod.latin.SuggestedWords;
import io.makerforce.inputmethod.latin.common.Constants;
import io.makerforce.inputmethod.latin.common.CoordinateUtils;
import io.makerforce.inputmethod.latin.settings.DebugSettings;
import io.makerforce.inputmethod.latin.utils.LanguageOnSpacebarUtils;
import io.makerforce.inputmethod.latin.utils.TypefaceUtils;
...
public final class MainKeyboardView extends KeyboardView implements DrawingProxy,
    ...
    public MainKeyboardView(final Context context, final AttributeSet attrs) {
        this(context, attrs, io.makerforce.inputmethod.latin.R.attr.mainKeyboardViewStyle);
    }
    ...
    public MainKeyboardView(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        final TypedArray mainKeyboardViewAttr = context.obtainStyledAttributes(
                attrs, io.makerforce.inputmethod.latin.R.styleable.MainKeyboardView, defStyle, io.makerforce.inputmethod.latin.R.style.MainKeyboardView);
        final int ignoreAltCodeKeyTimeout = mainKeyboardViewAttr.getInt(
                io.makerforce.inputmethod.latin.R.styleable.MainKeyboardView_ignoreAltCodeKeyTimeout, 0);
        final int gestureRecognitionUpdateTime = mainKeyboardViewAttr.getInt(
                io.makerforce.inputmethod.latin.R.styleable.MainKeyboardView_gestureRecognitionUpdateTime, 0);
        mTimerHandler = new TimerHandler(
                this, ignoreAltCodeKeyTimeout, gestureRecognitionUpdateTime);

        final float keyHysteresisDistance = mainKeyboardViewAttr.getDimension(
                io.makerforce.inputmethod.latin.R.styleable.MainKeyboardView_keyHysteresisDistance, 0.0f);
        final float keyHysteresisDistanceForSlidingModifier = mainKeyboardViewAttr.getDimension(
                io.makerforce.inputmethod.latin.R.styleable.MainKeyboardView_keyHysteresisDistanceForSlidingModifier, 0.0f);
        ...
        final int backgroundDimAlpha = mainKeyboardViewAttr.getInt(
                io.makerforce.inputmethod.latin.R.styleable.MainKeyboardView_backgroundDimAlpha, 0);
        mBackgroundDimAlphaPaint.setColor(Color.BLACK);
        mBackgroundDimAlphaPaint.setAlpha(backgroundDimAlpha);
        mLanguageOnSpacebarTextRatio = mainKeyboardViewAttr.getFraction(
                io.makerforce.inputmethod.latin.R.styleable.MainKeyboardView_languageOnSpacebarTextRatio, 1, 1, 1.0f);
        mLanguageOnSpacebarTextColor = mainKeyboardViewAttr.getColor(
                io.makerforce.inputmethod.latin.R.styleable.MainKeyboardView_languageOnSpacebarTextColor, 0);
        mLanguageOnSpacebarTextShadowRadius = mainKeyboardViewAttr.getFloat(
                io.makerforce.inputmethod.latin.R.styleable.MainKeyboardView_languageOnSpacebarTextShadowRadius,
                LANGUAGE_ON_SPACEBAR_TEXT_SHADOW_RADIUS_DISABLED);
        mLanguageOnSpacebarTextShadowColor = mainKeyboardViewAttr.getColor(
                io.makerforce.inputmethod.latin.R.styleable.MainKeyboardView_languageOnSpacebarTextShadowColor, 0);
        mLanguageOnSpacebarFinalAlpha = mainKeyboardViewAttr.getInt(
                io.makerforce.inputmethod.latin.R.styleable.MainKeyboardView_languageOnSpacebarFinalAlpha,
                Constants.Color.ALPHA_OPAQUE);
        final int languageOnSpacebarFadeoutAnimatorResId = mainKeyboardViewAttr.getResourceId(
                io.makerforce.inputmethod.latin.R.styleable.MainKeyboardView_languageOnSpacebarFadeoutAnimator, 0);
        final int altCodeKeyWhileTypingFadeoutAnimatorResId = mainKeyboardViewAttr.getResourceId(
                io.makerforce.inputmethod.latin.R.styleable.MainKeyboardView_altCodeKeyWhileTypingFadeoutAnimator, 0);
        final int altCodeKeyWhileTypingFadeinAnimatorResId = mainKeyboardViewAttr.getResourceId(
                io.makerforce.inputmethod.latin.R.styleable.MainKeyboardView_altCodeKeyWhileTypingFadeinAnimator, 0);

        mKeyPreviewDrawParams = new KeyPreviewDrawParams(mainKeyboardViewAttr);
        mKeyPreviewChoreographer = new KeyPreviewChoreographer(mKeyPreviewDrawParams);

        final int moreKeysKeyboardLayoutId = mainKeyboardViewAttr.getResourceId(
                io.makerforce.inputmethod.latin.R.styleable.MainKeyboardView_moreKeysKeyboardLayout, 0);
        final int moreKeysKeyboardForActionLayoutId = mainKeyboardViewAttr.getResourceId(
                io.makerforce.inputmethod.latin.R.styleable.MainKeyboardView_moreKeysKeyboardForActionLayout,
                moreKeysKeyboardLayoutId);
        mConfigShowMoreKeysKeyboardAtTouchedPoint = mainKeyboardViewAttr.getBoolean(
                io.makerforce.inputmethod.latin.R.styleable.MainKeyboardView_showMoreKeysKeyboardAtTouchedPoint, false);

        mGestureFloatingPreviewTextLingerTimeout = mainKeyboardViewAttr.getInt(
                io.makerforce.inputmethod.latin.R.styleable.MainKeyboardView_gestureFloatingPreviewTextLingerTimeout, 0);
        ...
        mLanguageOnSpacebarHorizontalMargin = (int)getResources().getDimension(
                io.makerforce.inputmethod.latin.R.dimen.config_language_on_spacebar_horizontal_margin);
    }
    ...
    public MoreKeysPanel showMoreKeysKeyboard(@Nonnull final Key key,
        ...
        final MoreKeysKeyboardView moreKeysKeyboardView =
                (MoreKeysKeyboardView)container.findViewById(io.makerforce.inputmethod.latin.R.id.more_keys_keyboard_view);
