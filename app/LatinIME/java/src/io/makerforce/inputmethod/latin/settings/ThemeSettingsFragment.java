...
public final class ThemeSettingsFragment extends SubScreenFragment
    ...
    static void updateKeyboardThemeSummary(final Preference pref) {
        ...
        final String[] keyboardThemeNames = res.getStringArray(io.makerforce.inputmethod.latin.R.array.keyboard_theme_names);
        final int[] keyboardThemeIds = res.getIntArray(io.makerforce.inputmethod.latin.R.array.keyboard_theme_ids);
    ...
    public void onCreate(final Bundle icicle) {
        ...
        addPreferencesFromResource(io.makerforce.inputmethod.latin.R.xml.prefs_screen_theme);
