...
package io.makerforce.inputmethod.latin.inputlogic;
...
import io.makerforce.inputmethod.compat.SuggestionSpanUtils;
...
import io.makerforce.inputmethod.latin.Dictionary;
import io.makerforce.inputmethod.latin.DictionaryFacilitator;
import io.makerforce.inputmethod.latin.LastComposedWord;
import io.makerforce.inputmethod.latin.LatinIME;
import io.makerforce.inputmethod.latin.NgramContext;
import io.makerforce.inputmethod.latin.RichInputConnection;
import io.makerforce.inputmethod.latin.Suggest;
import io.makerforce.inputmethod.latin.Suggest.OnGetSuggestedWordsCallback;
...
import io.makerforce.inputmethod.latin.WordComposer;
import io.makerforce.inputmethod.latin.common.Constants;
import io.makerforce.inputmethod.latin.common.InputPointers;
import io.makerforce.inputmethod.latin.common.StringUtils;
import io.makerforce.inputmethod.latin.define.DebugFlags;
import io.makerforce.inputmethod.latin.settings.SettingsValues;
import io.makerforce.inputmethod.latin.settings.SettingsValuesForSuggestion;
import io.makerforce.inputmethod.latin.settings.SpacingAndPunctuations;
import io.makerforce.inputmethod.latin.suggestions.SuggestionStripViewAccessor;
import io.makerforce.inputmethod.latin.utils.AsyncResultHolder;
import io.makerforce.inputmethod.latin.utils.InputTypeUtils;
import io.makerforce.inputmethod.latin.utils.RecapitalizeStatus;
import io.makerforce.inputmethod.latin.utils.StatsUtils;
import io.makerforce.inputmethod.latin.utils.TextRange;
