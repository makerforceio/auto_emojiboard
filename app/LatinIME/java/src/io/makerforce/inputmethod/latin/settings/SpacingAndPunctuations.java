...
import io.makerforce.inputmethod.latin.PunctuationSuggestions;
...
public final class SpacingAndPunctuations {
    ...
    public SpacingAndPunctuations(final Resources res) {
        ...
        mSortedSymbolsPrecededBySpace = StringUtils.toSortedCodePointArray(
                res.getString(io.makerforce.inputmethod.latin.R.string.symbols_preceded_by_space));
        ...
        mSortedSymbolsFollowedBySpace = StringUtils.toSortedCodePointArray(
                res.getString(io.makerforce.inputmethod.latin.R.string.symbols_followed_by_space));
        mSortedSymbolsClusteringTogether = StringUtils.toSortedCodePointArray(
                res.getString(io.makerforce.inputmethod.latin.R.string.symbols_clustering_together));
        ...
        mSortedWordConnectors = StringUtils.toSortedCodePointArray(
                res.getString(io.makerforce.inputmethod.latin.R.string.symbols_word_connectors));
        mSortedWordSeparators = StringUtils.toSortedCodePointArray(
                res.getString(io.makerforce.inputmethod.latin.R.string.symbols_word_separators));
        mSortedSentenceTerminators = StringUtils.toSortedCodePointArray(
                res.getString(io.makerforce.inputmethod.latin.R.string.symbols_sentence_terminators));
        mSentenceSeparator = res.getInteger(io.makerforce.inputmethod.latin.R.integer.sentence_separator);
        mAbbreviationMarker = res.getInteger(io.makerforce.inputmethod.latin.R.integer.abbreviation_marker);
        mSentenceSeparatorAndSpace = new String(new int[] {
                mSentenceSeparator, Constants.CODE_SPACE }, 0, 2);
        mCurrentLanguageHasSpaces = res.getBoolean(io.makerforce.inputmethod.latin.R.bool.current_language_has_spaces);
        ...
        final String[] suggestPuncsSpec = MoreKeySpec.splitKeySpecs(
                res.getString(io.makerforce.inputmethod.latin.R.string.suggested_punctuations));
