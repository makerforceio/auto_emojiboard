...
import io.makerforce.inputmethod.compat.UserDictionaryCompatUtils;
...
public class UserDictionaryAddWordContents {
    ...
    /* package */ UserDictionaryAddWordContents(final View view, final Bundle args) {
        mWordEditText = (EditText)view.findViewById(io.makerforce.inputmethod.latin.R.id.user_dictionary_add_word_text);
        mShortcutEditText = (EditText)view.findViewById(io.makerforce.inputmethod.latin.R.id.user_dictionary_add_shortcut);
        if (!UserDictionarySettings.IS_SHORTCUT_API_SUPPORTED) {
            mShortcutEditText.setVisibility(View.GONE);
            view.findViewById(io.makerforce.inputmethod.latin.R.id.user_dictionary_add_shortcut_label).setVisibility(View.GONE);
        }
    ...
    public static class LocaleRenderer {
        ...
        public LocaleRenderer(final Context context, @Nullable final String localeString) {
            ...
            if (null == localeString) {
                mDescription = context.getString(io.makerforce.inputmethod.latin.R.string.user_dict_settings_more_languages);
            } else if ("".equals(localeString)) {
                mDescription = context.getString(io.makerforce.inputmethod.latin.R.string.user_dict_settings_all_languages);
            } else {
