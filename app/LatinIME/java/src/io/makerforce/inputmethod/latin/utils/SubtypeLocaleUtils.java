...
public final class SubtypeLocaleUtils {
    ...
    private static final String RESOURCE_PACKAGE_NAME = io.makerforce.inputmethod.latin.R.class.getPackage().getName();

    // Special language code to represent "no language".
    public static final String NO_LANGUAGE = "zz";
    public static final String QWERTY = "qwerty";
    public static final String EMOJI = "emoji";
    public static final int UNKNOWN_KEYBOARD_LAYOUT = io.makerforce.inputmethod.latin.R.string.subtype_generic;
    ...
    private static void initLocked(final Context context) {
        ...
        final String[] predefinedLayoutSet = res.getStringArray(io.makerforce.inputmethod.latin.R.array.predefined_layouts);
        final String[] layoutDisplayNames = res.getStringArray(
                io.makerforce.inputmethod.latin.R.array.predefined_layout_display_names);
        ...
        final String[] exceptionalLocaleInRootLocale = res.getStringArray(
                io.makerforce.inputmethod.latin.R.array.subtype_locale_displayed_in_root_locale);
        ...
        final String[] exceptionalLocales = res.getStringArray(
                io.makerforce.inputmethod.latin.R.array.subtype_locale_exception_keys);
        ...
        final String[] keyboardLayoutSetMap = res.getStringArray(
                io.makerforce.inputmethod.latin.R.array.locale_and_extra_value_to_keyboard_layout_set_map);
    ...
    private static String getSubtypeLocaleDisplayNameInternal(@Nonnull final String localeString,
        ...
        if (NO_LANGUAGE.equals(localeString)) {
            ...
            return sResources.getString(io.makerforce.inputmethod.latin.R.string.subtype_no_language);
        }
