...
public final class SeekBarDialogPreference extends DialogPreference
    ...
    public SeekBarDialogPreference(final Context context, final AttributeSet attrs) {
        ...
        final TypedArray a = context.obtainStyledAttributes(
                attrs, io.makerforce.inputmethod.latin.R.styleable.SeekBarDialogPreference, 0, 0);
        mMaxValue = a.getInt(io.makerforce.inputmethod.latin.R.styleable.SeekBarDialogPreference_maxValue, 0);
        mMinValue = a.getInt(io.makerforce.inputmethod.latin.R.styleable.SeekBarDialogPreference_minValue, 0);
        mStepValue = a.getInt(io.makerforce.inputmethod.latin.R.styleable.SeekBarDialogPreference_stepValue, 0);
        a.recycle();
        setDialogLayoutResource(io.makerforce.inputmethod.latin.R.layout.seek_bar_dialog);
    }
    ...
    protected View onCreateDialogView() {
        ...
        mSeekBar = (SeekBar)view.findViewById(io.makerforce.inputmethod.latin.R.id.seek_bar_dialog_bar);
        mSeekBar.setMax(mMaxValue - mMinValue);
        mSeekBar.setOnSeekBarChangeListener(this);
        mValueView = (TextView)view.findViewById(io.makerforce.inputmethod.latin.R.id.seek_bar_dialog_value);
        return view;
    }
    ...
    protected void onPrepareDialogBuilder(final AlertDialog.Builder builder) {
        builder.setPositiveButton(android.R.string.ok, this)
            ...
            .setNeutralButton(io.makerforce.inputmethod.latin.R.string.button_default, this);
    }
