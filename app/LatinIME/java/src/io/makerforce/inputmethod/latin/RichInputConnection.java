...
import io.makerforce.inputmethod.compat.InputConnectionCompatUtils;
import io.makerforce.inputmethod.latin.common.Constants;
import io.makerforce.inputmethod.latin.common.UnicodeSurrogate;
import io.makerforce.inputmethod.latin.common.StringUtils;
import io.makerforce.inputmethod.latin.inputlogic.PrivateCommandPerformer;
...
import io.makerforce.inputmethod.latin.utils.NgramContextUtils;
import io.makerforce.inputmethod.latin.utils.ScriptUtils;
import io.makerforce.inputmethod.latin.utils.SpannableStringUtils;
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            for (final CharacterStyle span : spans) {
                ...
                // See Constants.UnicodeSurrogate
