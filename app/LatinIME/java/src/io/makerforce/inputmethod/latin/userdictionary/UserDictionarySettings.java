...
package io.makerforce.inputmethod.latin.userdictionary;
...
public class UserDictionarySettings extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActivity().getActionBar().setTitle(io.makerforce.inputmethod.latin.R.string.edit_personal_dictionary);
    }
    ...
    public View onCreateView(
        ...
        return inflater.inflate(
                io.makerforce.inputmethod.latin.R.layout.user_dictionary_preference_list_fragment, container, false);
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        emptyView.setText(io.makerforce.inputmethod.latin.R.string.user_dict_settings_empty_text);
    ...
    private ListAdapter createAdapter() {
        return new MyAdapter(getActivity(), io.makerforce.inputmethod.latin.R.layout.user_dictionary_item, mCursor,
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        MenuItem actionItem =
                menu.add(0, OPTIONS_MENU_ADD, 0, io.makerforce.inputmethod.latin.R.string.user_dict_settings_add_menu_title)
                .setIcon(io.makerforce.inputmethod.latin.R.drawable.ic_menu_add);
    ...
    private void showAddOrEditDialog(final String editingWord, final String editingShortcut) {
        ...
        pa.startPreferencePanel(UserDictionaryAddWordFragment.class.getName(),
                args, io.makerforce.inputmethod.latin.R.string.user_dict_settings_add_dialog_title, null, null, 0);
    }
    ...
    private static class MyAdapter extends SimpleCursorAdapter implements SectionIndexer {
        ...
        public MyAdapter(final Context context, final int layout, final Cursor c,
            ...
            if (null != c) {
                final String alphabet = context.getString(io.makerforce.inputmethod.latin.R.string.user_dict_fast_scroll_alphabet);
