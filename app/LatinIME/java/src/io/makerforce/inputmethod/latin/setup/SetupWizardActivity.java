...
package io.makerforce.inputmethod.latin.setup;
...
import io.makerforce.inputmethod.compat.TextViewCompatUtils;
import io.makerforce.inputmethod.compat.ViewCompatUtils;
import io.makerforce.inputmethod.latin.settings.SettingsActivity;
import io.makerforce.inputmethod.latin.utils.LeakGuardHandlerWrapper;
import io.makerforce.inputmethod.latin.utils.UncachedInputMethodManagerUtils;
...
public final class SetupWizardActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        setContentView(io.makerforce.inputmethod.latin.R.layout.setup_wizard);
        mSetupWizard = findViewById(io.makerforce.inputmethod.latin.R.id.setup_wizard);
        ...
        mWelcomeScreen = findViewById(io.makerforce.inputmethod.latin.R.id.setup_welcome_screen);
        final TextView welcomeTitle = (TextView)findViewById(io.makerforce.inputmethod.latin.R.id.setup_welcome_title);
        welcomeTitle.setText(getString(io.makerforce.inputmethod.latin.R.string.setup_welcome_title, applicationName));

        mSetupScreen = findViewById(io.makerforce.inputmethod.latin.R.id.setup_steps_screen);
        final TextView stepsTitle = (TextView)findViewById(io.makerforce.inputmethod.latin.R.id.setup_title);
        stepsTitle.setText(getString(io.makerforce.inputmethod.latin.R.string.setup_steps_title, applicationName));

        final SetupStepIndicatorView indicatorView =
                (SetupStepIndicatorView)findViewById(io.makerforce.inputmethod.latin.R.id.setup_step_indicator);
        mSetupStepGroup = new SetupStepGroup(indicatorView);

        mStep1Bullet = (TextView)findViewById(io.makerforce.inputmethod.latin.R.id.setup_step1_bullet);
        mStep1Bullet.setOnClickListener(this);
        final SetupStep step1 = new SetupStep(STEP_1, applicationName,
                mStep1Bullet, findViewById(io.makerforce.inputmethod.latin.R.id.setup_step1),
                io.makerforce.inputmethod.latin.R.string.setup_step1_title, io.makerforce.inputmethod.latin.R.string.setup_step1_instruction,
                io.makerforce.inputmethod.latin.R.string.setup_step1_finished_instruction, io.makerforce.inputmethod.latin.R.drawable.ic_setup_step1,
                io.makerforce.inputmethod.latin.R.string.setup_step1_action);
        ...
        final SetupStep step2 = new SetupStep(STEP_2, applicationName,
                (TextView)findViewById(io.makerforce.inputmethod.latin.R.id.setup_step2_bullet), findViewById(io.makerforce.inputmethod.latin.R.id.setup_step2),
                io.makerforce.inputmethod.latin.R.string.setup_step2_title, io.makerforce.inputmethod.latin.R.string.setup_step2_instruction,
                0 /* finishedInstruction */, io.makerforce.inputmethod.latin.R.drawable.ic_setup_step2,
                io.makerforce.inputmethod.latin.R.string.setup_step2_action);
        ...
        final SetupStep step3 = new SetupStep(STEP_3, applicationName,
                (TextView)findViewById(io.makerforce.inputmethod.latin.R.id.setup_step3_bullet), findViewById(io.makerforce.inputmethod.latin.R.id.setup_step3),
                io.makerforce.inputmethod.latin.R.string.setup_step3_title, io.makerforce.inputmethod.latin.R.string.setup_step3_instruction,
                0 /* finishedInstruction */, io.makerforce.inputmethod.latin.R.drawable.ic_setup_step3,
                io.makerforce.inputmethod.latin.R.string.setup_step3_action);
        ...
        mWelcomeVideoUri = new Uri.Builder()
                ...
                .path(Integer.toString(io.makerforce.inputmethod.latin.R.raw.setup_welcome_video))
                .build();
        final VideoView welcomeVideoView = (VideoView)findViewById(io.makerforce.inputmethod.latin.R.id.setup_welcome_video);
        ...
        mWelcomeImageView = (ImageView)findViewById(io.makerforce.inputmethod.latin.R.id.setup_welcome_image);

        mActionStart = findViewById(io.makerforce.inputmethod.latin.R.id.setup_start_label);
        mActionStart.setOnClickListener(this);
        mActionNext = findViewById(io.makerforce.inputmethod.latin.R.id.setup_next);
        mActionNext.setOnClickListener(this);
        mActionFinish = (TextView)findViewById(io.makerforce.inputmethod.latin.R.id.setup_finish);
        TextViewCompatUtils.setCompoundDrawablesRelativeWithIntrinsicBounds(mActionFinish,
                getResources().getDrawable(io.makerforce.inputmethod.latin.R.drawable.ic_setup_finish), null, null, null);
    ...
    void hideWelcomeVideoAndShowWelcomeImage() {
        ...
        mWelcomeImageView.setImageResource(io.makerforce.inputmethod.latin.R.raw.setup_welcome_image);
    ...
    static final class SetupStep implements View.OnClickListener {
        ...
        public SetupStep(final int stepNo, final String applicationName, final TextView bulletView,
            ...
            mActivatedColor = res.getColor(io.makerforce.inputmethod.latin.R.color.setup_text_action);
            mDeactivatedColor = res.getColor(io.makerforce.inputmethod.latin.R.color.setup_text_dark);

            final TextView titleView = (TextView)mStepView.findViewById(io.makerforce.inputmethod.latin.R.id.setup_step_title);
            ...
            mActionLabel = (TextView)mStepView.findViewById(io.makerforce.inputmethod.latin.R.id.setup_step_action_label);
        ...
        public void setEnabled(final boolean enabled, final boolean isStepActionAlreadyDone) {
            ...
            final TextView instructionView = (TextView)mStepView.findViewById(
                    io.makerforce.inputmethod.latin.R.id.setup_step_instruction);
